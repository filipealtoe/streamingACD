...
## CIKM 2026 artifact provenance

This directory is the retained source snapshot used for the CIKM 2026
claim-normalization evidence in
`results/ct25_claim_normalization_lambda_2026-05-15/`. The run is tied to source
commit `aa4864c299bbcd0b6dd60c13ace7742a2d0644a1` of
`https://github.com/filipealtoe/explainableACD`.

The public copy changes only the API-key diagnostic: it reports whether each key is
configured and never prints any part of a credential. Inference, retrieval,
post-processing, and metric behavior are unchanged.
