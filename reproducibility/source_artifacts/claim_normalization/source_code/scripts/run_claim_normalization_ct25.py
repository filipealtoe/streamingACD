...
def main():
    ...
    if args.local:
        ...
        # Report credential presence without exposing any credential bytes.
        import os
        ...
        print(
            ...
            f"OPENAI_API_KEY configured={openai_configured}; "
            f"TOGETHER_API_KEY configured={together_configured}"
        )
