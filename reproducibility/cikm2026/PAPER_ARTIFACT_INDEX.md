...
| PCA-64 + LLM + text-feature classifier | [feature-generation source](../source_artifacts/checkworthiness/source_code/scripts/feature_engineering/), [benchmark source](../source_artifacts/checkworthiness/source_code/scripts/benchmark_pca_llm_text.py), and [fresh-fit reproducer](../../scripts/reproduce_cikm2026_llm_features.py) | [text-free 153-feature matrices and labels](../source_artifacts/checkworthiness/llm_features_classifier/) | [full-precision fresh-fit result](../../results/llm_features_table_reproduction_2026-08-21.json), reproducing CT24 `0.694`, ClaimBuster `0.894`, and CT23 `0.846` under the retained per-benchmark threshold sweep and recording a fixed CT24-development-threshold diagnostic |
...
| Fusion classifier | [CT24 reproducer](../../scripts/reproduce_cikm2026_fusion_ct24.py) | [retained CT24 encoder, XGBoost, and Fusion probabilities](../source_artifacts/checkworthiness/fusion_classifier/) | [full-precision CT24 result](../../results/fusion_ct24_reproduction_2026-08-21.json), reproducing `0.836`; the [cross-benchmark recovery audit](../source_artifacts/checkworthiness/fusion_classifier/FUSION_RECOVERY_AUDIT.json) preserves the historical ClaimBuster `0.961` and CT23 `0.915` console metrics and documents the missing exact per-sample evidence |
