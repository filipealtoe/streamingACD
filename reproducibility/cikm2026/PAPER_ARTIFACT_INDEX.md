...
<!-- Sérgio Pinto, 2026-08-25 22:22 WEST — linked the verified version-pinned RandomForest paper-cell reconstruction. -->
...
| Numeric virality baselines | [tabular reproducer](../../scripts/reproduce_cikm2026_tabular_baselines.py), [RandomForest paper-cell reproducer](../../scripts/reproduce_cikm2026_random_forest.py), [statistical reproducer](../../scripts/reproduce_cikm2026_virality_statistics.py), and [parameters](MODEL_PARAMETERS.json) | Public feature matrix, deterministic `RandomState(42)` split, checksum-bound predictions, and the [original statistical run](../../results/psr_statistics_20260518_205609/) | The [tabular result](../../results/virality_tabular_reproduction_2026-08-21.json) verifies the deterministic fits, paper rows, and retained exact paired tests; the [version-pinned RandomForest result](../../results/virality_random_forest_reproduction_2026-08-25/) reconstructs its six published cells; the [statistical result](../../results/virality_statistics_reproduction_2026-08-21.json) reproduces all 11 Spearman p-values and bootstrap intervals plus all three exact McNemar tests |
